...
import { t as twMerge, F as Frame, i as is_void, B as Button, P } from "../../chunks/P.js";
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Navbar, "Navbar").$$render($$result, { class: "page-pad" }, {}, {
    default: ({ NavContainer: NavContainer2 }) => {
      return `${validate_component(NavContainer2, "NavContainer").$$render(
        $$result,
        {
          class: "border px-5 py-2 rounded-lg bg-white dark:bg-gray-600"
        },
        {},
        {
          default: () => {
            return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
              default: () => {
                return `<img src=" /kuber-logos.png" class="me-3 h-6 sm:h-9" alt=" Logo"> `;
              }
            })} ${validate_component(NavHamburger, "NavHamburger").$$render($$result, {}, {}, {})} ${validate_component(NavUl, "NavUl").$$render($$result, {}, {}, {
              default: () => {
                return `${validate_component(NavLi, "NavLi").$$render($$result, { href: "#features" }, {}, {
                  default: () => {
                    return `Features`;
                  }
                })}  ${validate_component(NavLi, "NavLi").$$render($$result, { href: "https://blog.kuberapp.net/" }, {}, {
                  default: () => {
                    return `Blog`;
                  }
                })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "https://demo.kuberapp.net/" }, {}, {
                  default: () => {
                    return `Demo`;
                  }
                })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "#waitlist" }, {}, {
                  default: () => {
                    return `Contact`;
                  }
                })}`;
              ...
              default: () => {
                return `<a href="#waitlist" style="text-decoration:none; color:white;" data-svelte-h="svelte-145q2td">Join Waitlist</a>`;
              }
            })}`;
          }
        }
...
const Footer_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Footer, "Footer").$$render($$result, { footerType: "logo" }, {}, {
    default: () => {
      return `<div class="sm:flex sm:items-center sm:justify-between foot">${validate_component(FooterBrand, "FooterBrand").$$render(
        $$result,
        {
          href: "https://kuberapp.net",
          src: " /kuber-logos.png",
          alt: "Kuber Logo"
        },
        {},
        ...
        $$result,
        {
          ulClass: "flex flex-wrap items-center mb-6 text-sm sm:mb-0 "
        },
        {},
        {
          default: () => {
            return `${validate_component(FooterLink, "FooterLink").$$render(
              $$result,
              {
                href: "https://blog.kuberapp.net",
                class: "text-black-important"
              },
              {},
              {
                default: () => {
              ...
              $$result,
              {
                href: "https://blog.kuberapp.net/legal/privacy-policy",
                class: "text-black-important"
              },
              {},
              {
              ...
              $$result,
              {
                href: "https://blog.kuberapp.net/legal/cookies-policy",
                class: "text-black-important"
              },
              {},
              {
      ...
      )}</div> <div class="foot1">${validate_component(FooterCopyright, "FooterCopyright").$$render(
        $$result,
        {
          href: "/",
          class: "text-black",
        ...
        {},
        {}
      )} <hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8"></div> ${validate_component(P, "P").$$render(
        $$result,
        {
          class: "mb-3 disclaimer",
          weight: "light",
        ...
        {
          default: () => {
            return `<strong class="font-semibold text-gray-900 dark:text-white" data-svelte-h="svelte-1pk4zeh">Disclaimer:</strong>
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="bg-white fixed top-0 left-0 w-full flex flex-col z-20 px-4 fadeIn">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}</div> <section data-svelte-h="svelte-14rd2ff"></section> ${slots.default ? slots.default({}) : ``} ${validate_component(Footer_1, "Footer").$$render($$result, {}, {}, {})}`;
});
export {
  Layout as default
};
