  ...
  <section class="container">
    ...
    >
      <div class="text-center space-y-8">
        ...
        >
          <h1>
            <span class="text-muted-foreground">Personal Finance </span><span class="text-slate-600 line-through">Is Hard</span>
            Just Got <span class="text-muted-foreground">Easier</span>
            with
            <span
        ...
        <p class="max-w-screen-md mx-auto text-xl text-muted-foreground">
          Less thinking & more doing. We're the one-stop finance app in your pocket. <br>
          It's 2024, don't look at your budgets and finances in excels or paper books.
        </p>
        ...
        <div class="space-y-4 md:space-y-0 md:space-x-4">
          ...
          <Button
            as-child
            variant="secondary"
            class="w-5/6 md:w-1/4 font-bold text-black"
          >
            <a
